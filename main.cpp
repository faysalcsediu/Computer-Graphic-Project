...
/////////Animation//////////
static float trcx,tsx,tcx = 0.0;
static float trcy,tsy,tcy = 0.0;


void objectsMoving(void) {
...
int main(int argc, char ** argv) {
    ...
    glutCreateWindow("My Town"); // Windows title name
